...
// Let's add tests so it's easier to automate testing for our new users functionality
describe('when there is initially one user in db', () => {
  // This adds a user with the username root to the database
  beforeEach(async () => {
  ...
  // This fails at first, because we're not testing for uniqueness.
